      ...
      <main className="mx-auto flex size-full min-h-fit max-w-5xl flex-col gap-28 px-6 py-10 opacity-0 motion-reduce:animate-none lg:py-16">
        <section className="relative flex flex-col gap-2">
          ...
          <Image
            ...
            alt=""
            data-parallax="-85"
            className="bg-image absolute top-10 -right-40 -z-1 size-100 object-contain md:-right-20 lg:-right-10 xl:top-15 xl:-right-35 xl:size-120 2xl:-right-60"
            quality={100}
          />
        </section>
        ...
        <div
          ...
          <Image
            ...
            alt=""
            data-parallax="-40"
            className="bg-image h-full w-full max-w-[1920px] translate-y-6 scale-115 object-contain lg:translate-y-24 xl:translate-y-32 xl:scale-100"
            quality={100}
            priority
          />
        </div>
