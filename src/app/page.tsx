  ...
  return (
    <>
      ...
      <main className="mx-auto flex size-full min-h-fit max-w-5xl flex-col gap-28 px-6 py-10 opacity-0 motion-reduce:animate-none lg:py-16">
        ...
        <div
          role="presentation"
          className="absolute bottom-0 left-0 -z-1 flex max-h-400 w-full justify-center overflow-hidden">
          <Image
            role="presentation"
            src={marsImg}
            alt=""
            className="bg-image h-full w-full max-w-[1920px] scale-110 object-contain"
            quality={100}
          />
        </div>
      </main>
