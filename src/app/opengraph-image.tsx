...
const GRAY_500 = 'rgb(106, 114, 130)'
const INDIGO_100 = 'rgb(224, 231, 255)'
const INDIGO_950 = 'rgb(30, 26, 77)'
      ...
      <div
        ...
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" width={112}>
            <circle cx="0" cy="0" r="2.05" fill={INDIGO_950} />
            <g stroke={INDIGO_950} stroke-width="1" fill="none">
          ...
          <svg fill="none" viewBox="0 0 512 512" width={112} xmlns="http://www.w3.org/2000/svg">
            <rect fill={INDIGO_950} height="512" rx="50" width="512" />
            <rect fill={INDIGO_950} height="512" rx="50" width="512" />
            <path
              clip-rule="evenodd"
